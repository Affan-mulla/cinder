    ...
    <footer className="bg-muted/50 border-t border-border py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Professional video recording made simple. Create, record, and share high-quality content effortlessly.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 Cinder. All rights reserved. Built with ❤️ for creators.</p>
        </div>
      </div>
    </footer>
  );
