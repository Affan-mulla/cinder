...
const Overlay = ({children} : {children: React.ReactNode}) => {
  ...
  return (
     <div className='bg-neutral-800 w-full h-screen  py-16 px-10 flex justify-center bg-[url("/bg-login.svg")] bg-cover'>
      <div className="flex justify-center items-center h-full bg-blur-3xl overflow-hidden md:w-fit w-full bg-neutral-950 rounded-2xl border-[2px] border-neutral-700/90">
        <div className="md:bg-neutral-900 px-5 py-4 bg-transparent h-full w-full flex-1 justify-center items-center flex">
